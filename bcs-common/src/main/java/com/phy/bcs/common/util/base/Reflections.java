package com.phy.bcs.common.util.base;
...
public class Reflections {
    ...
    public static boolean checkClassIsBase(String className) {
        if (PublicUtils.isNotEmpty(className) && PublicUtils.isNotEmpty(classPackge)) {
    ...
    public static Object invokeGetter(Object obj, String propertyName) {
        ...
        for (String name : StringUtils.split(propertyName, ".")) {
            object = invokeMethod(object, PublicUtils.toAppendStr(GETTER_PREFIX, StringUtils.capitalize(name)),
    ...
    public static void invokeSetter(Object obj, String propertyName, Object value) {
        ...
        for (int i = 0; i < names.length; i++) {
            if (i < names.length - 1) {
                object = invokeMethod(object, PublicUtils.toAppendStr(GETTER_PREFIX, StringUtils.capitalize(names[i])),
                        new Class[]{}, new Object[]{});
            } else {
                invokeMethodByName(object, PublicUtils.toAppendStr(SETTER_PREFIX, StringUtils.capitalize(names[i])),
                        new Object[]{value});
            }
        }
    }
    ...
    public static void setProperty(final Object obj, final PropertyDescriptor p, final Object value)
        ...
        if (typeName.contains(SystemConfig.TYPE_INT) || typeName.contains(SystemConfig.TYPE_INTEGER)) {
            PropertyUtils.setProperty(obj, p.getName(), Integer.parseInt(PublicUtils.toStrString(value)));
        } else if (typeName.contains("float") || typeName.contains(SystemConfig.TYPE_FLOAT)) {
            PropertyUtils.setProperty(obj, p.getName(), Float.parseFloat(PublicUtils.toStrString(value)));
        } else if (typeName.contains("double") || typeName.contains(SystemConfig.TYPE_DOUBLE)) {
            PropertyUtils.setProperty(obj, p.getName(), Double.parseDouble(PublicUtils.toStrString(value)));
        } else if (typeName.contains("long") || typeName.contains(SystemConfig.TYPE_LONG)) {
            PropertyUtils.setProperty(obj, p.getName(), Long.parseLong(PublicUtils.toStrString(value)));
        } else {
    ...
    public static void setProperty(final Object obj, final String propertyName, final Object value)
            throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
        if (PublicUtils.isNotEmpty(value)) {
    ...
    public static <T extends Annotation> T getAnnotation(Object obj, String pName, Class<T> annotationClass) {
        ...
        while (an == null && checkClassIsBase(temp.toString())) {
            ...
            try {
                if (an == null) {
                    an = temp.getDeclaredMethod(PublicUtils.toAppendStr(GETTER_PREFIX, StringUtils.capitalize(pName)))
    ...
    public static <T> T updateObj(Object obj, List<String> fields, Object... value) {
        try {
            if (obj != null) {
                if (PublicUtils.isNotEmpty(fields) && PublicUtils.isNotEmpty(value) && value.length == fields.size()) {
    ...
    /*public static void main(String[] args) {
        System.out.println(getMethodParameter("com.c503.boss.modules.com.c503.boss.modules.sys.controller.AreaController", "findTreeData"));
    }*/
