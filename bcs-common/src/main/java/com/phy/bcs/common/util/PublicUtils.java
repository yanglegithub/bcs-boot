...
/**
 * copyright 2014 boss all right reserved author somewhere created on 2014年12月12日 上午9:22:09
 */
...
public class PublicUtils {
    ...
    public static final String TIME_FORMAT_ISO_8601 = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";

    public static final Pattern PATTERN = Pattern.compile("\\s*|\t|\r|\n");

    protected static Logger logger = LoggerFactory.getLogger(PublicUtils.class);
    ...
    public static Boolean containsStr(String source, String str) {
        return PublicUtils.isNotEmpty(source) && source.contains(str);
    }
    ...
    public static String subMaxString(String str, Integer length) {
        if (PublicUtils.isNotEmpty(str) && str.length() > length) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (realLength > length) {
                    str = PublicUtils.toAppendStr(replaceBlank(str).substring(0, i), "...");
                    break;
                }
            }
        }
    ...
    public static Double round(Object value, int count) {
        return round(PublicUtils.parseDouble(value), count);
    }
     ...
     * @return
     */
    public static String toAppendStr(String... strs) {
        StringBuffer sb = new StringBuffer();
        for (Object str : strs) {
            if (isNotEmpty(str)) {
                sb.append(str);
    ...
    public static Object fmtDate(ZonedDateTime val) {
        return fmtDate(val, PublicUtils.TIME_FORMAT);
    }
