package com.phy.bcs.common.util.config;
...
public class SystemConfig {
    ...
    public static Integer getInteger(String name, int defaultValue) {
        ...
        return PublicUtils.parseInt(config, defaultValue);
    }

    public static Integer getInteger(String name) {
        String config = get(name);
        return PublicUtils.parseInt(config, null);
    }
    ...
    public static Long getLong(String name, long defaultValue) {
        String config = get(name);
        return PublicUtils.parseLong(config, defaultValue);
    }

    public static Long getLong(String name) {
        String config = get(name);
        return PublicUtils.parseLong(config, null);
    }

    public static Double getDouble(String name) {
        String config = get(name);
        return PublicUtils.parseDouble(config);
    }
    ...
    public static boolean getBoolean(String name) {
        String config = get(name);
        if (PublicUtils.isNotEmpty(config) && SYSTEM_TRUE.equalsIgnoreCase(config)) {
            return true;
        }
        return false;
    }
    ...
    public static void reload(String path) throws Exception {
        ...
        InputStream is = sc.getClass().getResourceAsStream("/xxx.properties");// properties
        // in
        // the
        // classpath
        props.load(is);
    ...
    public static void dumpSystemConfig() {
        ...
        if (props != null) {
            ...
            while (e.hasMoreElements()) {
                ...
                logger.info("boss.properties: " + key + " = " + value);
            }
        }
    }
